...
<html lang="en">
	...
	<body onload="document.querySelector('a[download]')?.click()">
		...
		<a href="https://github.com/FlorianLeChat/YouTube-Downloader" title="GitHub" target="_blank" style="position: fixed; inset: 0 0 auto auto; clip-path: polygon(0 0, 100% 0, 100% 100%);">
